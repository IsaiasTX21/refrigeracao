...
return (
    <> 
       <Header/>
<div style={{minHeight:"94vh"}} className="  container align-content-center justify-content-center">
...
A história da Sub-Zero começou com um técnico de eletrônica que trabalhava em uma empresa com diversos equipamentos de refrigeração, como ar-condicionado, freezers, bebedouros, geladeiras, expositores e câmaras frias. A empresa enfrentava problemas constantes com esses equipamentos, e a empresa de manutenção contratada não resolvia os problemas de forma eficaz, cobrando preços elevados.
